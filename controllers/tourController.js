...
exports.aliasTopTours = (req, res, next) => {
  ...
  req.query.fields = 'name,price,description,ratingAverage,summary,difficulty';
  next();
};
...
// /tours-within/200/center/40,50/unit/mi
...
exports.getToursWithin = catchAsync(async (req, res, next) => {
  ...
  if (!lat || !lng) {
    next(
      new AppError(
        'Please provide latitutr and longtiture in the format lat,lng',
        400
      )
    );
  }
